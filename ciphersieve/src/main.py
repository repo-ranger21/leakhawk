#!/usr/bin/env python3
"""
CipherSieve — Local-first password audit and remediation tool.
...
def main():
    parser = argparse.ArgumentParser(
        description="CipherSieve — local-first password audit and remediation."
    )
    ...
    fix_parser.add_argument("--output", default="ciphersieve_replacements.csv",
